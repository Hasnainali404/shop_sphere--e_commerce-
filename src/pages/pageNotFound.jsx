...
const PageNotFound = () => {
  return (
    <StyledWrapper>
      <div className="bg-stone-800 overflow-hidden min-h-screen flex items-center justify-center">
        ...
        <div className="absolute top-10 w-full text-center text-white z-20">
